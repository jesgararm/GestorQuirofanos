...
\imagen{postLimpieza}{Aspecto de los datos tras la limpieza y edición. Previo a codificación}{.9}
 ...
 Tras esta evaluación, encontramos que los valores referentes al \textbf{tipo, código de intervención y ponderación (\textit{prioridad})} son aquellos que, a priori, se encuentran más relacionados con la \textbf{duración}.
...
Tras la aplicación de esta medida, obtuvimos valores de error (\textit{reducción a menos de un 10\% de los previos}) mucho más coherentes y concordantes de la literatura, constituyendo un buen punto de partida para nuestro ensayo.
