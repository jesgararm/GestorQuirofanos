...
En total, se consideraron \textbf{25492 individuos} tras la realización de labores de adecuación e integración de las fuentes de datos.
 ...
 \imagen{tiposDatos}{Variables del Conjunto de Datos Base}{.9}\footnote{NHC: Número de Historia Clínica - Identificador.}
...
\textbf{Árbol de Regresion} & 2143.10 & 46.29 & \textbf{33.48}\\
